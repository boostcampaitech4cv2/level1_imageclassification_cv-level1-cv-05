...
def parse_args():
    ...
    parser.add_argument('--name', default='fest', help='model save at {SM_MODEL_DIR}/{name}')
    parser.add_argument('--weightedsampler', type=str, default='yes', help='weighted sampler (default: no  (no, yes))')
    parser.add_argument('--doc',type = str , default='2e-6,30대,40대,50대,backbone lr : 2e-6,age_decay :1e-3',help = 'comment about exp')
