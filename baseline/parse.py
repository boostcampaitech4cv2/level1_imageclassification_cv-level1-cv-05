...
def parse_args():
    ...
    parser.add_argument('--lr', type=float, default=2e-2, help='learning rate (default: 1e-3)')
    ...
    parser.add_argument('--name', default='vit_three_task', help='model save at {SM_MODEL_DIR}/{name}')
