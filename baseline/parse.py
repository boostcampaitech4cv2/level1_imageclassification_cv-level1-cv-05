...
def parse_args():
    ...
    parser.add_argument('--seed', type=int, default=40, help='random seed (default: 42)')
    parser.add_argument('--epochs', type=int, default=20, help='number of epochs to train (default: 1)')
    parser.add_argument('--dataset', type=str, default='Mydataset', help='dataset augmentation type (default: MaskBaseDataset)')
